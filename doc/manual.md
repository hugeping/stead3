...
Как вы уже знаете, объекты в инстед могут находиться в состоянии
...
1. Останавливаете цепочку life вызовов с помощью return false;
2. Очищаете вывод реакций: game:reaction(false);
3. Очищаете вывод живых методов на данный момент: game:events(false,
false)
4. Делаете walk.
