...
рамках этого каталога. Все ссылки на ресурсы делаются относительно текущего каталога -- каталога игры. В путях, при обращении
к ресурсам для разделения подкаталогов используйте символы /.
...
Далее, обычно следует указать модули, которые требуются игре. О модулях будет рассказано отдельно.
    ...
    require "format" -- некоторые функции форматирования
