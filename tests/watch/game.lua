...
obj {
	...
	act = function(s)
		...
		if visited 'Отсек 4 Пионер' and pioner_cap1 and pioner_cap2 and pioner_cap3 then
			p [[Все криокапсулы звездолета функционируют.]]
		end
	end;
};

dict.add('криоотсек2', function(s)
		 if visited 'Отсек 1 Пионер' and visited 'Отсек 2 Пионер' and visited 'Отсек 3 Пионер' and visited 'Отсек 4 Пионер'
		 and pioner_cap1 and pioner_cap2 and pioner_cap3 then
...
dict.add('жилойотсек2', function(s)
		 if visited 'Жилой Отсек 1 Пионер' and visited 'Жилой Отсек 2 Пионер' and visited 'Жилой Отсек 3 Пионер' and visited 'Жилой Отсек 4 Пионер' then
			 p [[Я обследовал все жилые отсеки, но не встретил бодрствующих членов экипажа. Как странно. Они все спят?]]
			 return
		 end
