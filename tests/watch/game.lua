...
{#столик|столик} и {#панель|инфо-панель.}]];
	...
	obj {
		...
		act = function(s)
			...
			p [[Пища появляется из панели выдачи на специальном подносе.]]
		end;
	}: with {
		obj {
			nam = '#поднос';
			dsc = [[{#кухня|Возле панели выдачи стоит} {поднос с моим завтраком}.]];
			tak = [[Я забрал поднос с кофе и яичницей. Интересно, из чего сделаны яйца?]];
