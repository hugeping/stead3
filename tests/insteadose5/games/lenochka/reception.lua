...
А как-то, поздно вечером, генерал потребовал принести кофе в лабораторию.]];
    decor=[["Леночка, будьте добры, принесите нам {#кофе|кофе}. Поздно, ребятам не мешало бы взбодриться."- Сказал он и быстро бросил трубку.]];
...
Стоп, конечно мне нужно отдохнуть, но не настолько ведь?!]];
    ...
    obj{
        nam="#стол";
        act=[[Ну уж нет!^
Сначало надо немного передохнуть, а потом можно будет и продолжить.]];
    };
