...
room {
	...
	onexit = function(s, t)
		if t/'2-й этаж' and not transport and door_try then
...
stuar = obj {
	...
	dsc = function(s)
		...
		elseif s.step >= 10 and s.step < 12 then
			p [[{Стюардесса} поравнялась с моим креслом. Я чувствую запах ее духов, который вызывает новые приступы мигрени.]]
		else
	...
	obj {
		nam = '#сумочка';
		act = [[Кажется, она держит в руках шприц! Черт, что это значит?]]
	}
}
...
-- Расслабьтесь.^
В этот момент мою шею пронзила боль. Я успел заметить шприц в руках стюардессы и мой мозг поглатила паника, чтобы в следующий
миг оставить меня в забытье...]];
	obj = {
		obj {
