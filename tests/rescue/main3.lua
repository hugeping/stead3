...
room {
	...
	enter = [[Звуки. Запахи. Свет. Гегель был сбит с толку, ведь только что была ночь, а теперь снова вечер. Странный холодильник.]];
...
room {
	...
	obj {
		nam = '#озеро';
		act = [[Пахнет рыбой и водорослями, но рыба в воде.]];
	}
}
